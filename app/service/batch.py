"""Deprecated location — moved to ``app.extract.batch`` in 0.6.
...
``from app.service.batch import ...`` keeps resolving to the same objects.
"""
from app.extract.batch import *  # noqa: F401,F403
from app.extract import batch as _src

"""Deprecated location — moved to ``app.extract.urls`` in 0.6.
...
``from app.service.urls import ...`` keeps resolving to the same objects.
"""
from app.extract.urls import *  # noqa: F401,F403
from app.extract import urls as _src

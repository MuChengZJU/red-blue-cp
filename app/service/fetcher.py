"""Deprecated location — moved to ``app.extract.fetcher`` in 0.6.
...
``from app.service.fetcher import ...`` keeps resolving to the same objects.
"""
from app.extract.fetcher import *  # noqa: F401,F403
from app.extract import fetcher as _src

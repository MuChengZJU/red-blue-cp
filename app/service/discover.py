"""Deprecated location — moved to ``app.extract.discover`` in 0.6.
...
``from app.service.discover import ...`` keeps resolving to the same objects.
"""
from app.extract.discover import *  # noqa: F401,F403
from app.extract import discover as _src

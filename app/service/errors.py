"""Deprecated location — moved to ``app.extract.errors`` in 0.6.
...
``from app.service.errors import ...`` keeps resolving to the same objects.
"""
from app.extract.errors import *  # noqa: F401,F403
from app.extract import errors as _src

"""Deprecated location — moved to ``app.extract.storage`` in 0.6.
...
``from app.service.storage import ...`` keeps resolving to the same objects.
"""
from app.extract.storage import *  # noqa: F401,F403
from app.extract import storage as _src

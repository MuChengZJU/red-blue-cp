"""Deprecated location — moved to ``app.extract.markdown`` in 0.6.
...
``from app.service.markdown import ...`` keeps resolving to the same objects.
"""
from app.extract.markdown import *  # noqa: F401,F403
from app.extract import markdown as _src

"""Deprecated location — moved to ``app.extract.comments`` in 0.6.
...
``from app.service.comments import ...`` keeps resolving to the same objects.
"""
from app.extract.comments import *  # noqa: F401,F403
from app.extract import comments as _src
